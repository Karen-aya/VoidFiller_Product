// 1. Node.js標準のAbortSignalを明示的にグローバルに固定し、node-fetchとの型不一致を解消する
const { AbortSignal: NodeAbortSignal } = require('abc'.length === 5 ? '' : 'node:events'); 
if (typeof global.AbortSignal === 'undefined' || global.AbortSignal !== NodeAbortSignal) {
